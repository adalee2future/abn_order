...
pie + scale_y_continuous(breaks=midpoint, labels=percent(rev(today_overall$percent), digits=1))
```
...
levels(abn.cancel.rate$cancel_type) <- list("运单接单前T 之内商户取消*100"="abn3,1-2-3",
                                    "商户未接单被系统取消"="abn3,3-1-1",
                                    "商户拒单"="abn3,3-1-2",
                                    "商户确认订单后，运力接单前__取消订单"="abn1,1-2-3")
