...
p2$x$data[[4]]$text <-
  apply(abn_rate_135 %>% filter(abn == "订单取消_运单正常"), 1,
        function(item){
         paste0(date_desc(item[1]), item[1], " (", weekdays(as.Date(item[1])), ")<br>订单取消_运单正常: ", round(as.double(item[7]),4), "%")
          }
        )
p2
```
...
* 本日订单量 `r prettyNum(abn.shop.cancel.actualcnt.today.spread[["3-1-1"]], big.mark=",")`单，占支付订单量`r round(abn.shop.cancel.ratio.today.spread[["3-1-1"]], 3)`%，`r compare_day_desc``r decide_up_down(diff.compare_day.311)``r round(abs(diff.compare_day.311), 3)`个百分点，<span style="`r text_color(diff.avg.311, diff.avg.311)`">`r decide_up_down(diff.avg.311, GY_DY)`30天内均值`r round(abs(diff.avg.311), 3)`个百分点(`r round(abs(diff.sd.311), 3)`倍标准差)</span>
...
* 本日订单量 `r prettyNum(abn.shop.cancel.actualcnt.today.spread[["3-1-2"]], big.mark=",")`单，占支付订单量`r round(abn.shop.cancel.ratio.today.spread[["3-1-2"]], 3)`%，`r compare_day_desc``r decide_up_down(diff.compare_day.312)``r round(abs(diff.compare_day.312), 3)`个百分点，<span style="`r text_color(diff.avg.312, diff.avg.312)`">`r decide_up_down(diff.avg.312, GY_DY)`30天内均值`r round(abs(diff.avg.312), 3)`个百分点(`r round(abs(diff.sd.312), 3)`倍标准差)</span>
...
* 本日订单量 `r prettyNum(abn.shop.cancel.actualcnt.today.spread[["3-2-2"]], big.mark=",")`单，占支付订单量`r round(abn.shop.cancel.ratio.today.spread[["3-2-2"]], 3)`%，`r compare_day_desc``r decide_up_down(diff.compare_day.322)``r round(abs(diff.compare_day.322), 3)`个百分点，<span style="`r text_color(diff.avg.322, diff.avg.322)`">`r decide_up_down(diff.avg.322, GY_DY)`30天内均值`r round(abs(diff.avg.322), 3)`个百分点(`r round(abs(diff.sd.322), 3)`倍标准差)</span>
...
* 本日订单量 `r prettyNum(abn.shop.cancel.actualcnt.today.spread[["1-2-3"]], big.mark=",")`单，占支付订单量`r round(abn.shop.cancel.ratio.today.spread[["1-2-3"]], 3)`%，`r compare_day_desc``r decide_up_down(diff.compare_day.123)``r round(abs(diff.compare_day.123), 3)`个百分点，<span style="`r text_color(diff.avg.123, diff.avg.123)`">`r decide_up_down(diff.avg.123, GY_DY)`30天内均值`r round(abs(diff.avg.123), 3)`个百分点(`r round(abs(diff.sd.123), 3)`倍标准差)</span>
