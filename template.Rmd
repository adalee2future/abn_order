...
* 今日订单量 `r prettyNum(abn.today$created, big.mark=",")` 单，比前一天`r decide_up_down(created.diff.yesterday)` `r prettyNum(abs(created.diff.yesterday), big.mark=",")`单，<span style="`r text_color(created.diff.avg, created.diff.sd)`">`r decide_up_down(created.diff.avg, GY_DY)`30天内均值`r prettyNum(abs(created.diff.avg), big.mark=",")`
